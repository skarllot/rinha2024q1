...
namespace Marten.Generated.DocumentStorage
{
    ...
    public class UpsertDeadLetterEventOperation834684974 : Marten.Internal.Operations.StorageOperation<Marten.Events.Daemon.DeadLetterEvent, System.Guid>
    {
        ...
        public const string COMMAND_TEXT = "select stream.mt_upsert_deadletterevent(?, ?, ?, ?)";
    ...
    public class InsertDeadLetterEventOperation834684974 : Marten.Internal.Operations.StorageOperation<Marten.Events.Daemon.DeadLetterEvent, System.Guid>
    {
        ...
        public const string COMMAND_TEXT = "select stream.mt_insert_deadletterevent(?, ?, ?, ?)";
    ...
    public class UpdateDeadLetterEventOperation834684974 : Marten.Internal.Operations.StorageOperation<Marten.Events.Daemon.DeadLetterEvent, System.Guid>
    {
        ...
        public const string COMMAND_TEXT = "select stream.mt_update_deadletterevent(?, ?, ?, ?)";
    ...
    public class DeadLetterEventBulkLoader834684974 : Marten.Internal.CodeGeneration.BulkLoader<Marten.Events.Daemon.DeadLetterEvent, System.Guid>
    {
        ...
        public const string MAIN_LOADER_SQL = "COPY stream.mt_doc_deadletterevent(\"mt_dotnet_type\", \"id\", \"mt_version\", \"data\") FROM STDIN BINARY";

        public const string TEMP_LOADER_SQL = "COPY mt_doc_deadletterevent_temp(\"mt_dotnet_type\", \"id\", \"mt_version\", \"data\") FROM STDIN BINARY";

        public const string COPY_NEW_DOCUMENTS_SQL = "insert into stream.mt_doc_deadletterevent (\"id\", \"data\", \"mt_version\", \"mt_dotnet_type\", mt_last_modified) (select mt_doc_deadletterevent_temp.\"id\", mt_doc_deadletterevent_temp.\"data\", mt_doc_deadletterevent_temp.\"mt_version\", mt_doc_deadletterevent_temp.\"mt_dotnet_type\", transaction_timestamp() from mt_doc_deadletterevent_temp left join stream.mt_doc_deadletterevent on mt_doc_deadletterevent_temp.id = stream.mt_doc_deadletterevent.id where stream.mt_doc_deadletterevent.id is null)";

        public const string OVERWRITE_SQL = "update stream.mt_doc_deadletterevent target SET data = source.data, mt_version = source.mt_version, mt_dotnet_type = source.mt_dotnet_type, mt_last_modified = transaction_timestamp() FROM mt_doc_deadletterevent_temp source WHERE source.id = target.id";

        public const string CREATE_TEMP_TABLE_FOR_COPYING_SQL = "create temporary table mt_doc_deadletterevent_temp as select * from stream.mt_doc_deadletterevent limit 0";
